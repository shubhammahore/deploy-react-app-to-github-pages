...
3. Fill in the form as follows:
    - **Repository name:** You can enter any name you want\*.
        ...
        I'll enter: `deploy-react-app-to-github-pages`
...
1. Create a React app named `deploy-react-app-to-github-pages`:

    > In case you want to use a different name from `deploy-react-app-to-github-pages` (e.g. `web-ui`), you can accomplish that by replacing all occurrences of `deploy-react-app-to-github-pages` in this tutorial, with that other name (i.e. `deploy-react-app-to-github-pages` --> `web-ui`).
  
    ```shell
    $ npx create-react-app deploy-react-app-to-github-pages
    ```
    ...
    > ```shell
    > $ npx create-react-app deploy-react-app-to-github-pages --template typescript
    > ```

    That command will create a new folder named `deploy-react-app-to-github-pages`, which will contain the source code of a React app.
...
2. Enter the newly-created folder:
    ...
    ```shell
    $ cd deploy-react-app-to-github-pages
    ```
...
2. Add a `homepage` property in this format\*: `https://{username}.github.io/{repo-name}`
    ...
    ```diff
    {
      ...
      "version": "0.1.0",
    + "homepage": "https://gitname.github.io/eploy-react-app-to-github-pages",
      "private": true,
    ```
...
1. Add a "[remote](https://git-scm.com/docs/git-remote)" to the local Git repository.
    ...
    ```shell
    $ git remote add origin https://github.com/gitname/deploy-react-app-to-github-pages.git
    ```
...
1. Push the React app to the GitHub repository
    ...
    > By default, the new commit on the `gh-pages` branch will have a commit message of "Updates". You can [specify a custom commit message](https://github.com/gitname/deploy-react-app-to-github-pages/issues/80#issuecomment-1042449820) via the `-m` option, like this:
    > ```shell
...
At this point, the React app is accessible to anyone who visits the `homepage` URL you specified in Step 4. For example, the React app I deployed is accessible at https://gitname.github.io/deploy-react-app-to-github-pages.
...
3. [Preserving the `CNAME` file when using a custom domain](https://github.com/gitname/deploy-react-app-to-github-pages/issues/89#issuecomment-1207271670)
...
<a href="https://github.com/shubhammahore" target="_blank" title="rhulse">
  <img src="https://github.com/shubhammahore.png?size=300" height="300" width="300" alt="rhulse" />
</a>
